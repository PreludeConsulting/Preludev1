...
async function sendEmail(context, { to, code, challengeId, requestId: rid }) {
  ...
  const html = `<!doctype html><html><body style="margin:0;padding:0;background:#f4efff;font-family:Arial,Helvetica,sans-serif;color:#171423;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f4efff;padding:32px 16px;"><tr><td align="center"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;background:#ffffff;border:1px solid #e9ddff;border-radius:16px;padding:32px;box-shadow:0 18px 48px rgba(80,35,180,.12);"><tr><td><img src="${logoUrl}" width="74" alt="Prelude" style="display:block;width:74px;height:auto;margin:0 0 20px;"><h1 style="margin:0 0 12px;font-size:26px;line-height:1.25;color:#21103f;">Your Prelude verification code</h1><p style="margin:0 0 18px;font-size:16px;line-height:1.6;color:#4e4564;">Use this code to finish signing in:</p><p style="margin:0 0 20px;font-size:40px;line-height:1;letter-spacing:10px;font-weight:700;color:#6d28d9;">${code}</p><p style="margin:0 0 12px;font-size:15px;line-height:1.6;color:#4e4564;">This code expires in 10 minutes.</p><p style="margin:0 0 12px;font-size:13px;line-height:1.5;color:#716780;">Requested around ${issuedAt} from ${device}.</p><p style="margin:0 0 20px;font-size:13px;line-height:1.5;color:#716780;">If you did not attempt to sign in, you can safely ignore this email and consider changing your password.</p><p style="margin:0;font-size:12px;line-height:1.5;color:#8a8098;">Prelude Consulting LLC</p></td></tr></table></td></tr></table></body></html>`;
