...
/**
 * Quadratic Bézier path with perpendicular control offset so arcs cross naturally.
 * @param {number} ax
 * @param {number} ay
 * @param {number} bx
 * @param {number} by
 * @param {number} [seed=0] — alternates curve direction
 */
...
/**
 * Build k-nearest-neighbor mesh edges between university nodes.
 * @param {NetworkPoint[]} points
 * @param {{ density?: 'default' | 'compact', maxEdges?: number }} [options]
 * @returns {NetworkEdge[]}
 */
